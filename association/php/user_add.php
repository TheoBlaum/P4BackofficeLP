...
<body class="bg-black">
    ...
    <div class="flex h-screen">
        ...
        <div class="absolute bottom-20 right-10 transform -translate-x-1/2">
            <svg width="131" height="209" viewBox="0 0 131 209" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="94" cy="36" rx="37" ry="36" fill="#1BB761" />
                <path d="M93.5 95C93.5 172.2 31.8333 188.833 1 187.5" stroke="white" stroke-width="41" />
            </svg>
        </div>
    </div>
