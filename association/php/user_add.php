...
<body class="bg-black">
    ...
    <div class="flex h-screen">
        ...
        <div
            ...
            <h1 class="text-4xl font-bold max-w-xl mx-auto text-white mb-6">Ajouter un Bénévole</h1>
            ...
            <div
                ...
                <form action="user_add.php" method="POST">
                    <div class="mb-4">
                        <label class="block text-green-500 mb-2 font-medium">Nom :</label>
                    ...
                    <div class="mb-4">
                        <label class="block text-green-500 mb-2 font-medium">Email :</label>
                    ...
                    <div class="mb-4">
                        <label class="block text-green-500 mb-2 font-medium">Mot de passe :</label>
                        <div class="relative">
                            <input type="password" name="mot_de_passe" id="mot_de_passe"
                                class="w-full p-2 bg-neutral-900/30 backdrop-blur-lg border border-white/20 text-white p-6 rounded-lg shadow-xl max-w-xl mx-auto"
                                placeholder="Mot de passe" required>
                            <button type="button" onclick="togglePassword('mot_de_passe', 'eyeIcon')" class="absolute right-3 top-1/2 -translate-y-1/2 text-white/60 hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4" id="eyeIcon">
                    ...
                    <div class="mb-4">
                        <label class="block text-green-500 mb-2 font-medium">Rôle :</label>
                        <select name="role"
                            class="w-full p-2 bg-neutral-900/30 backdrop-blur-lg border border-white/20 text-white p-6 rounded-lg shadow-xl max-w-xl mx-auto">
        ...
        <div class="absolute bottom-20 right-10 transform -translate-x-1/2">
            <svg width="74" height="213" viewBox="0 0 74 213" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M37 72C57.4345 72 74 55.8823 74 36C74 16.1177 57.4345 0 37 0C16.5655 0 0 16.1177 0 36C0 55.8823 16.5655 72 37 72Z"
                    fill="#1BB761" />
                <rect x="3" y="87" width="68" height="126" rx="28" fill="white" />
            </svg>
        </div>
    </div>
