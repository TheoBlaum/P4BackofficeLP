...
<body class="bg-black">
    ...
    <div class="flex h-screen">
        ...
        <div
            ...
            <!-- Titre -->
            <h1 class="text-4xl font-bold text-stone-500 max-w-xl mx-auto mb-6">Ajouter une collecte</h1>

            <!-- Formulaire -->
            <div
                class="bg-neutral-900/30 backdrop-blur-lg border border-white/20 text-white p-6 rounded-lg shadow-xl max-w-xl mx-auto mb-8 ">
                <form method="POST" class="space-y-4">
                    <!-- Date -->
                    <div>
                        <label class="block text-sm mb-2 font-medium text-green-500">Date :</label>
                    ...
                    <!-- Lieu -->
                    <div>
                        <label class="block text-sm mb-2 font-medium text-green-500">Lieu :</label>
                        <input type="text" name="lieu" required placeholder="Lieu de la collecte"
                            class="w-full p-2 bg-neutral-900/30 backdrop-blur-lg border border-white/20 text-white p-6 rounded-lg shadow-xl max-w-xl mx-auto">
                    </div>
                    <style>
                        input::placeholder {
                    ...
                    <div>
                        <label class="block text-sm mb-2 font-medium text-green-500">Bénévole Responsable :</label>
        ...
        <div class="absolute bottom-20 left-[57%] transform -translate-x-1/2">
            <svg width="346" height="133" viewBox="0 0 519 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M85.2776 25.5C91.8209 14.1667 108.179 14.1667 114.722 25.5L171.88 124.5C178.423 135.833 170.244 150 157.158 150H42.8423C29.7557 150 21.5766 135.833 28.1199 124.5L85.2776 25.5Z"
                    fill="#1BB761" />
                <ellipse cx="272" cy="83" rx="68" ry="66" fill="#1BB761" />
                <path
                    d="M387 57C387 34.9086 404.909 17 427 17H448.5C487.436 17 519 48.5639 519 87.5V109C519 131.091 501.091 149 479 149H427C404.909 149 387 131.091 387 109V57Z"
                    fill="#FDFDFD" />
            </svg>
        </div>
    </div>
