...
<body class="bg-black">
    ...
    <div class="flex h-screen">
        ...
        <div
            ...
            <div class="flex">
                <div
                    class="bg-neutral-900/30 backdrop-blur-lg border m-5 max-w-2xl mb-8 border-white/20 text-white p-6 rounded-lg shadow-xl w-1/2">
                    <form method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="type_dechet" required
                                class="w-full p-2 bg-neutral-900/30 backdrop-blur-lg border border-white/20 text-white mb-4 p-6 rounded-lg shadow-xl max-w-xl mx-auto">
                            ...
                            <label for="quantite_kg" class="block text-sm font-medium mb-2 text-green-500">Quantité (kg)
                                :</label>
                        ...
                        <div class="flex justify-end space-x-4">
                            <a href="collection_list.php"
                                class="bg-neutral-800/30 backdrop-blur-lg border border-white/20 hover:bg-neutral-600/30 text-white  hover:text-red-500  px-4 py-2 rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-red-500 transition duration-200">Annuler</a>
                            <button type="submit"
                                class="bg-neutral-800/30 backdrop-blur-lg border border-white/20 hover:bg-neutral-600/30 text-white px-4 py-2 rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200">Modifier</button>
                        </div>
                    </form>
                </div>
                ...
                <div
                    class=" w-1/2 bg-neutral-900/30 backdrop-blur-lg m-5 mb-8 border border-white/20 text-white p-6 rounded-lg shadow-xl">
                    <h2 class="text-2xl font-bold mb-4 text-white">Déchets enregistrés</h2>
                    <table
                        class="overflow-hidden bg-neutral-900/30 backdrop-blur-lg border border-white/20 border-collapse text-white w-full  mb-8 rounded-lg shadow-xl">
                        ...
                        <tbody>
                            <?php foreach ($dechets_collectes as $dechet): ?>
                                <tr>
                                    <td class="hover:bg-neutral-800 transition duration-500 ease-in-out px-4 py-2">
                                        <?= htmlspecialchars($dechet['type_dechet']) ?></td>
                                    <td class="hover:bg-neutral-800 transition duration-500 ease-in-out px-4 py-2">
                                        <?= htmlspecialchars($dechet['quantite_kg']) ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
